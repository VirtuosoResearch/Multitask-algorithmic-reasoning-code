...
# for num_sample in 1000 2000 3000 
# do
...
# for num_sample in 5000 8000 10000
# do
# PYTHONPATH="${REPO_ROOT}/clrs${PYTHONPATH:+:${PYTHONPATH}}" python train_mtl.py --algorithms "dijkstra"\
#   --cfg "./configs/dijkstra/GINE.yml" --lr 5e-5 --hidden_dim 128 --gnn_layers 2 --enable_gru --enbale_gru_task_wise --devices 1 --batch_size 400 --epochs 100 --runs 1 --loss_weight_hint 0\
#   --save_name "mtl"\
...
# for num_sample in 25000 30000 40000
# do
# PYTHONPATH="${REPO_ROOT}/clrs${PYTHONPATH:+:${PYTHONPATH}}" python train_mtl.py --algorithms "dijkstra"\
#   --cfg "./configs/dijkstra/GINE.yml" --lr 5e-5 --hidden_dim 128 --gnn_layers 2 --enable_gru --enbale_gru_task_wise --devices 1 --batch_size 400 --epochs 100 --runs 1 --loss_weight_hint 0\
#   --save_name "mtl"\
...
do
PYTHONPATH="${REPO_ROOT}/clrs${PYTHONPATH:+:${PYTHONPATH}}" python train_mtl.py --algorithms "dijkstra"\
  --cfg "./configs/dijkstra/GINE.yml" --lr 5e-5 --hidden_dim 128 --gnn_layers 2 --enable_gru --enbale_gru_task_wise --devices 1 --batch_size 400 --epochs 1 --runs 1 --loss_weight_hint 0\
  --save_name "mtl"\
  --data_dir data/ --num_samples $num_sample --node 12
done

for num_sample in 200000 300000 400000
do
PYTHONPATH="${REPO_ROOT}/clrs${PYTHONPATH:+:${PYTHONPATH}}" python train_mtl.py --algorithms "dijkstra"\
  --cfg "./configs/dijkstra/GINE.yml" --lr 5e-5 --hidden_dim 128 --gnn_layers 2 --enable_gru --enbale_gru_task_wise --devices 1 --batch_size 400 --epochs 1 --runs 1 --loss_weight_hint 0\
  --save_name "mtl"\
...
for num_sample in 400000 600000 800000
do
PYTHONPATH="${REPO_ROOT}/clrs${PYTHONPATH:+:${PYTHONPATH}}" python train_mtl.py --algorithms "dijkstra"\
  --cfg "./configs/dijkstra/GINE.yml" --lr 5e-5 --hidden_dim 128 --gnn_layers 2 --enable_gru --enbale_gru_task_wise --devices 1 --batch_size 400 --epochs 1 --runs 1 --loss_weight_hint 0\
  --save_name "mtl"\
...
# python train_mtl.py --algorithms "mst_prim"\
#   --cfg "./configs/bfs/GIN.yml" --lr 5e-5 --hidden_dim 128 --gnn_layers 2 --enable_gru --enbale_gru_task_wise --devices 1 --batch_size 400 --epochs 100 --runs 1 --loss_weight_hint 0\
#   --save_name "mtl"\
#   --data_dir data/ --num_samples 100000 --node 20 --enable_wandb
